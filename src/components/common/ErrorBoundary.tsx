    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-gray-950 px-4">
        <div className="max-w-md text-center">
          ...
          <h1 className="mb-2 text-xl font-bold text-gray-100">Something Went Wrong</h1>
          <p className="mb-6 text-sm leading-relaxed text-gray-400">
            The character engine hit an unexpected error. Your selections haven't been lost — try
            resetting, or reload the page if the issue persists.
          </p>
          {this.state.error && (
