...
export function Toggle({ checked, onChange, 'aria-label': ariaLabel, size = 'md' }: ToggleProps) {
  ...
  return (
    ...
    >
      <span className={`absolute top-0.5 left-0.5 ${config.dot} rounded-full bg-white transition-transform ${
