...
import { ELEMENT_LIST, getAbilityName } from "../../../data/index.ts";
...
const COGNITIVE_FUNCTION_LIST: CognitiveFunction[] = [
  "Ti",
  "Te",
  "Fi",
  "Fe",
  ...
  switch (systemId) {
    ...
    case "mbti":
      return (
        <div>
          <span className="mb-2 block text-xs font-medium text-gray-500">
            Pick a cognitive function for each ability slot
          </span>
          <div className="space-y-2">
            {ABILITY_SLOT_LIST.map(({ slot, label }) => (
              <div key={slot} className="flex items-center gap-2">
                <span className="w-16 text-xs font-semibold text-gray-400">
                  {label}
                </span>
                <div className="flex-1">
                  <Select
                    ...
                    onChange={(value) => {
                      const currentAbilities: AbilityOverrides =
                        overrides.abilities ?? {
                          hero: "Ti",
                          parent: "Ti",
                          child: "Ti",
                      ...
                      onUpdateOverride("abilities", {
                        ...currentAbilities,
                        [slot]: value as CognitiveFunction,
                      });
                    }}
      ...
      return (
        <div>
          ...
          <Select
            ...
            onChange={(value) =>
              onUpdateOverride("element", (value as Element) || null)
            }
    ...
    case "instincts":
      return (
        <div>
          <span className="mb-2 block text-xs font-medium text-gray-500">
            Choose combat orientation
          </span>
          <Select
            value={overrides.combatOrientation ?? ""}
            onChange={(value) =>
              onUpdateOverride("combatOrientation", value || null)
            }
