...
interface ReportSectionProps {
  ...
  report: string | null;
  onSetReport: (report: string) => void;
}
...
export function ReportSection({
  ...
  return (
    <div>
      ...
      {report ? (
        <div className="rounded-lg border border-indigo-800/50 bg-linear-to-b from-indigo-950/20 to-gray-800 p-5">
        ...
        <div className="rounded-lg border border-indigo-800/50 bg-linear-to-b from-indigo-950/30 to-gray-900 p-6">
          <div className="flex items-start gap-4">
            ...
            <div className="min-w-0 flex-1">
              <h4 className="text-sm font-bold text-gray-100">
                How do {characterName}&apos;s systems interact?
              </h4>
