...
describe('generateSystemInsights', () => {
  ...
  it('detects 3-system convergence when Hero scaling stat matches highest AP stat', () => {
    ...
    expect(insightList.some((i) => i.includes('triple-layered convergence'))).toBe(true)
  })
  ...
  it('detects aggressive class with methodical Hero function', () => {
    ...
    expect(insightList.some((i) => i.includes('disciplined chaos agent'))).toBe(true)
  })
  ...
  it('detects support class with aggressive Hero function', () => {
    ...
    expect(insightList.some((i) => i.includes('aggressive primary ability'))).toBe(true)
  })
  ...
  it('detects AP lowest stat matching Inferior scaling stat', () => {
    ...
    expect(insightList.some((i) => i.includes('Inferior') || i.includes('thin base, big spikes'))).toBe(true)
  })
  ...
  it('detects quadra-class alignment', () => {
    ...
    expect(insightList.some((i) => i.includes('thematic alignment'))).toBe(true)
  })
  ...
  it('detects instinct tritype cross-center passives', () => {
    ...
    expect(insightList.some((i) => i.includes('cross-center passive'))).toBe(true)
  })
  ...
  it('detects Frontline orientation with strategist class', () => {
    ...
    expect(insightList.some((i) => i.includes('frontline intellectual'))).toBe(true)
  })
  ...
  it('includes tritype stat blending insight when tritype is active', () => {
    ...
    expect(insightList.some((i) => i.includes('40%') && i.includes('20%'))).toBe(true)
  })
